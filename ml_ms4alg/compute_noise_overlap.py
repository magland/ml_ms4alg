...
def compute_noise_overlap(recording,sorting,unit_ids):
    ...
    for unit in unit_ids:
        ...
        clips=np.stack(recording.getSnippets(snippet_len=clip_size, center_frames=times))
        
        clips_control=np.stack(recording.getSnippets(snippet_len=clip_size, center_frames=times_control))
